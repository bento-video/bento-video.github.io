...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const handleCaseStudyNav = () => {
    ...
    if (getWindowHeight() < 500 || getWindowWidth() < 1100) {
      ...
      $sideNavLogo.fadeOut(100);   /* .stop(true, true).css("display", "none"); */
      $caseStudyNav.fadeOut(100);   /* .stop(true, true).css("display", "none"); */
      $toTop.fadeOut(100);   /* .stop(true, true).css("display", "none"); */
    }
